...
def main():
    ...
    num_extrusions_range = [2, 4, 6, 8, 10]
    extrusion_ranges = [0.1, 0.2, 0.3, 0.4]
    rotation_ranges = [45, 90, 180, 360]
    random_seeds = [random.randint(0, 10000) for _ in range(4)]  # 4 different random seeds
